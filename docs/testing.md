...
- `tests/statusline/test-superpowers-statusline.sh` — bash tests for the progress statusline: plan discovery, SDD ledger and checkbox counting, rendering options.
